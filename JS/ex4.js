...
for (databook in dataB) {
    document.getElementById("add_items").innerHTML +=
        ...
        <img src="../image/book.png" alt="#"><div class="name">Name : ${dataB[databook].name}</div><div class="price">Price : ${dataB[databook].price} riels</div>
...
function insertNewRecord(data) {
    ...
    document.getElementById("add_items").innerHTML +=
        ...
        <button id="${parseInt(databook)}" class="editBtn" onclick="editBook(this.id)">change name</button>
        <button id="${parseInt(databook)}" class="deleteBtn" onclick="deleteBook(this.id)">Delete</button></div>
        <img src="../image/book.png" alt="#"><div class="name" data="${x}">Name : ${databooks[x].name}</div><div class="price">Price : ${databooks[x].price} riels</div>
    ...
    if (confirm('Are you sure want to delete this book?')) {
        ...
        for (databook in databooks) {
            document.getElementById("add_items").innerHTML +=
                ...
                <img src="../image/book.png" alt="#"><div class="name">Name : ${databooks[databook].name}</div>
